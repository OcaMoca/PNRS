...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void insert(Data data) {
        ...
        Data d = exists(data.getLocation(),data.getDate_time());
    ...
    public Data exists(String location, String date_time){
    ...
    public void insert_location(Data data) {
        ...
        Data d = exists_location(data.getLocation());
    ...
    public Data exists_location(String location){
        SQLiteDatabase db = this.getReadableDatabase();
        Data data;
    ...
    public Data[] read_all_data(){
        ...
        Data[] all_data = new Data[cursor.getCount()];
        int i = 0;
    ...
    public Data readData(String location){
        SQLiteDatabase db = getReadableDatabase();
        Cursor cursor = db.query(TABLE_NAME, null, COLUMN_LOCATION + "=?",
                new String[] {location}, null, null, null);
        cursor.moveToLast();
        Data data = createData(cursor);
    ...
    public Data readDay(String day){
        SQLiteDatabase db = getReadableDatabase();
    ...
    public Data[] read_data_location(String location){
        SQLiteDatabase db = getReadableDatabase();
    ...
    public Data[] sort_date_time(String location){
        SQLiteDatabase db = getReadableDatabase();
    ...
    private Data createData(Cursor cursor){
        ...
        return new Data(day, date_time, location, temperature, pressure, humidity, sun_set, sun_rise, wind_speed, wind_direction);
    }
    ...
    public Data[] read_all_data_loc(String location){
        SQLiteDatabase db = getReadableDatabase();
        Cursor cursor = db.query(TABLE_NAME, null, COLUMN_LOCATION + "=?",
                new String[] {location}, null, null, null);
